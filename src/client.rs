...
use nostr_types::{Event, EventKind, Filter, PreEvent, PrivateKey, PublicKey, PublicKeyHex, Tag, Unixtime};

const EXAMPLE_OWNER_PUBKEY: &'static str = "00000b6b73abad367cd1924ab6700d381582a585ddc40c25df2b2be6d737488f";
const EXAMPLE_OWNER_PRVKEY: &'static str = "93342b31aee9d0597bdf9d851ab8ea6b724c83752dac8de4e4c90bee0054ebec";

const EXAMPLE_OTHER_PUBKEY: &'static str = "f332a54f2bd94988dce7f56d3df5845c2a301455c3bdd387b5c2ff0f8ca1c55a";
const EXAMPLE_OTHER_PRVKEY: &'static str = "cbfa9fb8b54ec27e570da7e27a454aec5f8550f61dcc71d7a932967b3d53455c";
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    assert!( response.get_ref().answer );
    ...
    let pre_event = PreEvent {
        ...
        created_at: Unixtime::now()?,
        kind: EventKind::RelayList,
        tags: vec![Tag::Pubkey { pubkey: owner_pubkeyhex.clone(),
